...
public class SetFloatBehaviour : StateMachineBehaviour
{
    ...
    // OnStateMachineEnter is called when a transition ends and the state machine finishes evaluating this state
    ...
    // OnStateMachineExit is called when a transition ends and the state machine finishes evaluating this state
